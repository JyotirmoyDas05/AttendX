...
package `in`.jyotirmoy.attendx.settings.presentation.page.mainscreen.screen
...
import `in`.jyotirmoy.attendx.core.presentation.components.lottie.SpinningGearsLottie

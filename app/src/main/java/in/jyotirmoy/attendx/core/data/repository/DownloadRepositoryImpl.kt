package `in`.jyotirmoy.attendx.core.data.repository
...
import `in`.jyotirmoy.attendx.core.utils.isNetworkAvailable
...
class DownloadRepositoryImpl @Inject constructor(
    ...
    private fun createRequest(url: String, file: File): DownloadManager.Request {
        return DownloadManager.Request(url.toUri()).apply {
            ...
            setDescription("AttendX update is downloading...")
